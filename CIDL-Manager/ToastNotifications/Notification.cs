...
namespace ToastNotifications
{
    public partial class Notification : Form
    {
        ...
        public Notification(string title, string body, int duration, FormAnimator.AnimationMethod animation, FormAnimator.AnimationDirection direction, bool isRTL = false)
        {
            if (isRTL)
            {
